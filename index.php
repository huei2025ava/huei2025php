...
<body>
  <h1>🌱 Huei 的 PHP 練習作品集</h1>
  <p>這裡記錄我在職訓局學習 PHP 的過程，<br>每一個小練習，都是邁向工程師的腳印 👣</p>
  ...
  <div class="card">
    <h2>🧮 array</h2>
    <p></p>
    <a href="./pra_array/array.php">▶ 執行程式</a>
    <a href="./show_readme.php?file=pra_99/README.md">📘 查看說明筆記</a>
  </div>
  ...
  <div class="card">
    <h2>🧮 Date</h2>
    <p></p>
    <a href="./pra_date/date.php">▶ 執行程式</a>
    <a href="./show_readme.php?file=pra_99/README.md">📘 查看說明筆記</a>
  </div>
  ...
  <div class="card">
    <h2>🧮 GET、POST運用</h2>
    <p></p>
    <a href="./pra_get_post/getpost.php">▶ 執行程式</a>
    <a href="./show_readme.php?file=pra_99/README.md">📘 查看說明筆記</a>
  </div>
